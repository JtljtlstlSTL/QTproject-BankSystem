...
#include "../../experient/registerdialog.h"
...
QT_MOC_LITERAL(3, 36, 21) // "on_buttonBox_accepted"
    ...
    "RegisterDialog\0registrationSuccess\0\0"
...
void RegisterDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterDialog::registrationSuccess)) {
                *result = 0;
                return;
            }
        }
